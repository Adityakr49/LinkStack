...
export default async function UserPage({ params }) {
  ...
  //add event count for views
  await Event.create({ uri: uri, page: uri, type: "view" });
  // await Event.deleteMany({});
  return (
    <div className="bg-blue-950 text-white min-h-screen">
      <div
        className="h-56 bg-gray-40 bg-cover bg-center"
        style={
          page.bgType === "color"
        ...
        {page.links.map((link) => (
          ...
          >
            <div className="relative -left-4 overflow-hidden w-16">
              <div className="w-16 h-16 relative flex bg-blue-700 aspect-square items-center justify-center">
                {link.icon && (
                  <Image
