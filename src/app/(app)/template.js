...
import { faBars, faGripLines, faLink } from "@fortawesome/free-solid-svg-icons";
    ...
    <html lang="en">
      <body className={lato.className}>
        ...
        <main className="md:flex min-h-screen">
          <label
            htmlFor="navCb"
            className="md:hidden ml-8 pt-4 p-4 rounded-md bg-white shadow inline-flex items-center gap-2 cursor-pointer"
          >
